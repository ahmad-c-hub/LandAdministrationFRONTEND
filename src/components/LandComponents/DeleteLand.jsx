...
const DeleteLand = () => {
  ...
  const fetchLand = async () => {
    try {
      const res = await axios.get(`http://landadministration.railway.internal/land/get/${landId}`);
      setLand(res.data);
      setShowModal(true);
      setError("");
    } catch (err) {
  ...
  const handleDelete = async () => {
    try {
      const res = await axios.delete(`http://landadministration.railway.internal/land/delete/${landId}`);
